...
Public Class OrderItem
    ...
    Private m_VoidReason As String
    Private m_FoodFrom As String
    ...
    Friend Sub LoadData(ByVal SqlDr As SqlDataReader)
        ...
        For i = 0 To SqlDr.FieldCount - 1 'reads every column in a record
            ...
            Select Case SqlDrColName
                ...
                Case "VoidReason"
                    If Not SqlDr.IsDBNull(i) Then
                        m_VoidReason = SqlDr.GetString(i)
                    Else
                        m_VoidReason = " "
                    End If
                Case "CrownPrice"
    ...
    Public Property VoidReason() As String
        ...
        End Set
    End Property
    Public Property FoodFrom() As String
        Get
            Return m_FoodFrom
        End Get
        Set(ByVal Value As String)
