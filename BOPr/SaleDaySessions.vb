...
Public Class SaleDaySessions
    ...
    Public Function AddNewSDSession(ByVal enumSessionId As Session.enumSessionName) As SaleDaySession
        ...
        Else
            ...
            m_SaleDays = SaleDays.CreateSaleDay()
            objSD = m_SaleDays.Item(Me.SaleDate, False)

            With objSDSession
                .SessionId = enumSessionId
                .SaleDate = Me.SaleDate
                .SaleDayId = objSD.SaleDayId
            End With
            Me.Add(objSDSession)
            intSQLReturnValue = objSDSession.SetData(True)
        End If
        Return objSDSession
    End Function
