...
Public Class rptQBRevenueReport
    ...
    Private Sub LoadRevenueData(ByVal objSaleDay As SaleDay)
        ...
        For Each objSDSession In objSaleDay.AllSaleDaySessions
            ...
            With fgReport
                ...
                .Item(intNextRow, .Cols.Item("Taxable").Index) = 0

                dblAmount = +objSDSession.TipAmountPaid()
    ...
    Private Sub LoadPaymentsData(ByVal objSaleDay As SaleDay)
