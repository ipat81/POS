...
Public Class rptSalesSummary
    ...
    Private Sub SetfgReport()
        ...
        With fgReport.Cols(3)
            fgReport(0, 3) = "Customer"
            .Width = 100
            .WidthDisplay = 40
            'fgReport(1, 3) = "Table"
            .Name = "TakeOutCustomerName"
            .DataType = GetType(String)
            .AllowDragging = True
            .AllowSorting = True
        End With
    ...
    Private Sub SetSubTotalTree()
        With fgReport
            ...
            .Subtotal(C1FlexGrid.AggregateEnum.Sum, -1, -1, .Cols.Item("GCSale").Index, "Grand Total")
    ...
    Private Sub LoadOrders(ByVal objSDSession As SaleDaySession)
        ...
        For Each objOrder In objSDSession.AllOrders
            With fgReport
                ...
                '        .Item(intNextRow, 2) = "Take Out"
                'End Select
                .Item(intNextRow, 2) = objOrder.OrderReceivedFrom

                '.Item(intNextRow, 3) = objOrder.Table.TableName & "-" & objOrder.TableSeating.ToString
                .Item(intNextRow, 3) = objOrder.TakeOutCustomerName
