...
Public Class POSPrint
    ...
    Friend AxOPOSPrinter As New OPOSPOSPrinter
    ...
    Private Sub GrabPOSPrinter()        'Grabs Printer & Cash Drawer
        ...
        With AxOPOSPrinter
            ...
            If .DeviceEnabled = False Then
                ...
                '.
                '.AsyncMode = False
                '.TransactionPrint(PTR_S_RECEIPT, 0)
            End If
    ...
    Private Sub PrintHeader(ByVal printDoc As PosDoc)
        ...
        With AxOPOSPrinter
            ...
            .PrintNormal(3, Chr(10))            'end of line
            For Each strLine In printDoc.HeaderLines

                If i = 0 Then
                    Select Case printDoc.POSDocType
                        Case PosDoc.enumPOSDocType.GuestCheck
                            .PrintNormal(3, Chr(27) + "|4C" & strLine)
                        Case PosDoc.enumPOSDocType.KOT
                            .PrintNormal(3, Chr(27) + "|2C" & strLine)
                    End Select
                Else
                    .PrintNormal(3, Chr(27) & "|bC" & strLine)
                End If
                rc = .ResultCodeExtended()
                i += 1
                .PrintNormal(3, Chr(10))
            Next
        End With
    End Sub
