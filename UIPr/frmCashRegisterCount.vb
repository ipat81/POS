            ...
            Case True
                ...
                Select Case Char.IsDigit(e.KeyChar)
                    ...
                    Case False
                        ...
                        Select Case Char.IsSymbol(e.KeyChar) Or Char.IsLetter(e.KeyChar) Or _
                                    Char.IsPunctuation(e.KeyChar) Or Char.IsSeparator(e.KeyChar)
                            Case True
                                e.Handled = True
        ...
        Select Case SelectedSDSession.MoneyCountEditAllowed(SelectedMoneycount)
            ...
            Case True
                Select Case Char.IsLetter(e.KeyChar) Or Char.IsSeparator(e.KeyChar)
                    ...
                    Case False
                        Try
                            If e.KeyChar = ControlChars.Back Or Char.GetNumericValue(e.KeyChar) = CType(Shortcut.Del, Double) Then
                                e.Handled = False
                            Else
